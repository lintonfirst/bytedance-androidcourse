        ...
        new Thread(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        RequestBody imagerequest = RequestBody.create(MediaType.parse("multipart/form-data"), coverImageData);
                        MultipartBody.Part imagebody = MultipartBody.Part.createFormData("image", "img.jpg", imagerequest);
                        Call<UploadResponse> call = api.submitMessage(Constants.STUDENT_ID, "", frombody, tobody, contentbody, imagebody, Constants.token);
                        try {
